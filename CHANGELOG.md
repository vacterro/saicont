...
- **SAICONT TERMINAL**: new `--terminal` mode and `SAICONT_TERMINAL.cmd` launcher opening the branded monitor/dispatcher adapter window with 265 deterministic self-tests.
